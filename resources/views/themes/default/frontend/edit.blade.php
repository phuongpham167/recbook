                ...
                <div class="_form dangnhap_page bg_fdfdfd">
                    <div class="form-horizontal">
                        ...
                        <dl>
                            ...
                            <dd>
                                <input type="text" name="title" id="title" required placeholder="{{trans('frontend.title')}}" value="{{old('title',$data->title)}}"/>
                        ...
                        <dl>
                            ...
                            <dd>
                                <input type="text" name="domain" id="domain" placeholder="{{trans('frontend.domain')}}" value="{{old('domain',$data->domain)}}">
                        ...
                        <dl>
                            <section class="new-deal">
                                ...
                                <input type="text" name="theme" id="input-theme" value="{{old('theme',$data->theme)}}" hidden>
                                <div class="container">
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 deal deal-block">
                                        <div @if($data->theme == 'BDS-01') class="item-slide picked" @else class="item-slide" @endif >
                                            <div class="box-img">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 deal deal-block">
                                        <div @if($data->theme == 'BDS-02') class="item-slide picked" @else class="item-slide" @endif>
                                            <div class="box-img">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 deal deal-block">
                                        <div @if($data->theme == 'BDS-03') class="item-slide picked" @else class="item-slide" @endif>
                                            <div class="box-img">
    ...
    <script>
        ...
        $(document).on('click', '.btn-submit', function(e){
            ...
            if(theme != '' && title != '' && domain !='')
            {
                ...
                $.post('<?php echo asset('frontend/edit'); ?>', {theme, title, domain, id, _token: '{{csrf_token()}}'}, function(r){
