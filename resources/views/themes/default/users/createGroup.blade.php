        ...
        <div class="row subpage">
            ...
            <div class="col-xs-9 right">
                ...
                <div class="listlandA_page">
                    <p class="title_boxM"><strong><i class="fa fa-file-pdf-o"></i>Thêm mới nhóm khách hàng</strong> <a href="{{route('userListGroup')}}" class="btn btn-xs btn-primary pull-right"><i class="fa fa-chevron-left"></i> Quay lại</a></p>
                    <div>
                        <div class="box-body">
