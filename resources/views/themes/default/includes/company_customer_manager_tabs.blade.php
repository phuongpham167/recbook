...
<ul class="nav nav-tabs">
    ...
    ?>
    @if(!empty($group_id))
        <li role="presentation" @if(url()->current() == asset('doanh-nghiep/{id}')) class="active" @endif><a class="freelancer_tab" href="{{route('companyDetail',['id'=>$group_id])}}">Quản lý thành viên nhóm</a></li>
    @endif
