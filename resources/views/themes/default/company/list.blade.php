...
@section('meta-description')
    <meta name="description" content="Company's Customer Page" >
@endsection
        ...
        <div class="row subpage">
            ...
            <div class="col-xs-9 right">
                ...
                <div class="listlandA_page">
                    <p class="title_boxM"><strong><i class="fa fa-user-o"></i>Danh sách khách hàng công ty</strong></p>
                    <div>
                        <div class="box-body">
    ...
    <script>
        $(function() {
            datatable = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    'url': urlDatatable ='{!! route('companyCustomerData') !!}',
                    'type': 'GET',
                    'data': function (d) {
                        d.id    =   {{request('id')}};
