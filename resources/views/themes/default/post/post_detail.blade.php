...
@section('meta-description')
    <meta name="description" content="{{\App\PostCategory::find($data->postcategory_id)->name}}" >
@endsection
        ...
        <div class="row subpage">
            ...
            <div class="col-xs-12 col-md-9 left catland_page">
                ...
                <div class="_box">
                    ...
                    <p class="title_box"><strong>{{\App\PostCategory::find($data->postcategory_id)->name}}</strong></p>
                    <div class="">

                        <div class="news_page">
                            <h1>{{$data->title}}</h1>
                            {{--<p>Cập nhật: 28-11-2017 | Lượt xem: 1164  | <a href="/dien-dan--hoi-dap-l17.htm">Diễn đàn &amp; Hỏi Đáp</a></p>--}}
                            ...
                            <div class="brief_news_page"><p style="text-align:center"><span style="font-size:24px"><span style="color:#0000CD"><strong>{{$data->title}}</strong></span></span></p>
                            </div>
